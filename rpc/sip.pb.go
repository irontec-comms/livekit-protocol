...
type InternalHoldSIPParticipantRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SipCallId     string                 `protobuf:"bytes,1,opt,name=sip_call_id,json=sipCallId,proto3" json:"sip_call_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *InternalHoldSIPParticipantRequest) Reset() {
	*x = InternalHoldSIPParticipantRequest{}
	mi := &file_rpc_sip_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *InternalHoldSIPParticipantRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InternalHoldSIPParticipantRequest) ProtoMessage() {}

func (x *InternalHoldSIPParticipantRequest) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_sip_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InternalHoldSIPParticipantRequest.ProtoReflect.Descriptor instead.
func (*InternalHoldSIPParticipantRequest) Descriptor() ([]byte, []int) {
	return file_rpc_sip_proto_rawDescGZIP(), []int{3}
}

func (x *InternalHoldSIPParticipantRequest) GetSipCallId() string {
	if x != nil {
		return x.SipCallId
	}
	return ""
...
type InternalUnholdSIPParticipantRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SipCallId     string                 `protobuf:"bytes,1,opt,name=sip_call_id,json=sipCallId,proto3" json:"sip_call_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *InternalUnholdSIPParticipantRequest) Reset() {
	*x = InternalUnholdSIPParticipantRequest{}
	mi := &file_rpc_sip_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *InternalUnholdSIPParticipantRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InternalUnholdSIPParticipantRequest) ProtoMessage() {}

func (x *InternalUnholdSIPParticipantRequest) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_sip_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InternalUnholdSIPParticipantRequest.ProtoReflect.Descriptor instead.
func (*InternalUnholdSIPParticipantRequest) Descriptor() ([]byte, []int) {
	return file_rpc_sip_proto_rawDescGZIP(), []int{4}
}

func (x *InternalUnholdSIPParticipantRequest) GetSipCallId() string {
	if x != nil {
		return x.SipCallId
	}
	return ""
...
const file_rpc_sip_proto_rawDesc = "" +
	...
	"!InternalHoldSIPParticipantRequest\x12\x1e\n" +
	"\vsip_call_id\x18\x01 \x01(\tR\tsipCallId\"E\n" +
	"#InternalUnholdSIPParticipantRequest\x12\x1e\n" +
	"\vsip_call_id\x18\x01 \x01(\tR\tsipCallId2\xd7\x03\n" +
	"\vSIPInternal\x12u\n" +
	...
	"\x16TransferSIPParticipant\x12*.rpc.InternalTransferSIPParticipantRequest\x1a\x16.google.protobuf.Empty\"\x15\xb2\x89\x01\x11\x10\x01\x1a\r\x12\vsip_call_id\x12k\n" +
	"\x12HoldSIPParticipant\x12&.rpc.InternalHoldSIPParticipantRequest\x1a\x16.google.protobuf.Empty\"\x15\xb2\x89\x01\x11\x10\x01\x1a\r\x12\vsip_call_id\x12o\n" +
	"\x14UnholdSIPParticipant\x12(.rpc.InternalUnholdSIPParticipantRequest\x1a\x16.google.protobuf.Empty\"\x15\xb2\x89\x01\x11\x10\x01\x1a\r\x12\vsip_call_idB!Z\x1fgithub.com/livekit/protocol/rpcb\x06proto3"
...
var file_rpc_sip_proto_goTypes = []any{
	...
	(*InternalHoldSIPParticipantRequest)(nil),     // 3: rpc.InternalHoldSIPParticipantRequest
	(*InternalUnholdSIPParticipantRequest)(nil),   // 4: rpc.InternalUnholdSIPParticipantRequest
	nil,                             // 5: rpc.InternalCreateSIPParticipantRequest.ParticipantAttributesEntry
	nil,                             // 6: rpc.InternalCreateSIPParticipantRequest.HeadersEntry
	nil,                             // 7: rpc.InternalCreateSIPParticipantRequest.HeadersToAttributesEntry
	nil,                             // 8: rpc.InternalCreateSIPParticipantRequest.AttributesToHeadersEntry
...
var file_rpc_sip_proto_depIdxs = []int32{
	...
	5,  // 1: rpc.InternalCreateSIPParticipantRequest.participant_attributes:type_name -> rpc.InternalCreateSIPParticipantRequest.ParticipantAttributesEntry
	6,  // 2: rpc.InternalCreateSIPParticipantRequest.headers:type_name -> rpc.InternalCreateSIPParticipantRequest.HeadersEntry
	7,  // 3: rpc.InternalCreateSIPParticipantRequest.headers_to_attributes:type_name -> rpc.InternalCreateSIPParticipantRequest.HeadersToAttributesEntry
	8,  // 4: rpc.InternalCreateSIPParticipantRequest.attributes_to_headers:type_name -> rpc.InternalCreateSIPParticipantRequest.AttributesToHeadersEntry
	...
	9,  // 10: rpc.InternalTransferSIPParticipantRequest.headers:type_name -> rpc.InternalTransferSIPParticipantRequest.HeadersEntry
	13, // 11: rpc.InternalTransferSIPParticipantRequest.ringing_timeout:type_name -> google.protobuf.Duration
	...
	3,  // 14: rpc.SIPInternal.HoldSIPParticipant:input_type -> rpc.InternalHoldSIPParticipantRequest
	4,  // 15: rpc.SIPInternal.UnholdSIPParticipant:input_type -> rpc.InternalUnholdSIPParticipantRequest
	1,  // 16: rpc.SIPInternal.CreateSIPParticipant:output_type -> rpc.InternalCreateSIPParticipantResponse
	15, // 17: rpc.SIPInternal.TransferSIPParticipant:output_type -> google.protobuf.Empty
	15, // 18: rpc.SIPInternal.HoldSIPParticipant:output_type -> google.protobuf.Empty
	15, // 19: rpc.SIPInternal.UnholdSIPParticipant:output_type -> google.protobuf.Empty

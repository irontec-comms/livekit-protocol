...
type SIPHoldStatus int32

const (
	SIPHoldStatus_SHS_HOLD_ONGOING      SIPHoldStatus = 0
	SIPHoldStatus_SHS_HOLD_FAILED       SIPHoldStatus = 1
	SIPHoldStatus_SHS_HOLD_SUCCESSFUL   SIPHoldStatus = 2
	SIPHoldStatus_SHS_UNHOLD_SUCCESSFUL SIPHoldStatus = 3
)

// Enum value maps for SIPHoldStatus.
var (
	SIPHoldStatus_name = map[int32]string{
		0: "SHS_HOLD_ONGOING",
		1: "SHS_HOLD_FAILED",
		2: "SHS_HOLD_SUCCESSFUL",
		3: "SHS_UNHOLD_SUCCESSFUL",
	}
	SIPHoldStatus_value = map[string]int32{
		"SHS_HOLD_ONGOING":      0,
		"SHS_HOLD_FAILED":       1,
...
func (x SIPHoldStatus) Enum() *SIPHoldStatus {
	p := new(SIPHoldStatus)
	*p = x
	return p
}

func (x SIPHoldStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SIPHoldStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_livekit_sip_proto_enumTypes[6].Descriptor()
}

func (SIPHoldStatus) Type() protoreflect.EnumType {
	return &file_livekit_sip_proto_enumTypes[6]
}

func (x SIPHoldStatus) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SIPHoldStatus.Descriptor instead.
func (SIPHoldStatus) EnumDescriptor() ([]byte, []int) {
...
type HoldSIPParticipantRequest struct {
	state               protoimpl.MessageState `protogen:"open.v1"`
	ParticipantIdentity string                 `protobuf:"bytes,1,opt,name=participant_identity,json=participantIdentity,proto3" json:"participant_identity,omitempty"`
	RoomName            string                 `protobuf:"bytes,2,opt,name=room_name,json=roomName,proto3" json:"room_name,omitempty"`
	unknownFields       protoimpl.UnknownFields
...
func (x *HoldSIPParticipantRequest) Reset() {
	*x = HoldSIPParticipantRequest{}
	mi := &file_livekit_sip_proto_msgTypes[37]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *HoldSIPParticipantRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HoldSIPParticipantRequest) ProtoMessage() {}

func (x *HoldSIPParticipantRequest) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_sip_proto_msgTypes[37]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HoldSIPParticipantRequest.ProtoReflect.Descriptor instead.
func (*HoldSIPParticipantRequest) Descriptor() ([]byte, []int) {
	return file_livekit_sip_proto_rawDescGZIP(), []int{37}
}

func (x *HoldSIPParticipantRequest) GetParticipantIdentity() string {
	if x != nil {
		return x.ParticipantIdentity
	}
	return ""
...
func (x *HoldSIPParticipantRequest) GetRoomName() string {
	if x != nil {
		return x.RoomName
	}
	return ""
...
type UnholdSIPParticipantRequest struct {
	state               protoimpl.MessageState `protogen:"open.v1"`
	ParticipantIdentity string                 `protobuf:"bytes,1,opt,name=participant_identity,json=participantIdentity,proto3" json:"participant_identity,omitempty"`
	RoomName            string                 `protobuf:"bytes,2,opt,name=room_name,json=roomName,proto3" json:"room_name,omitempty"`
	unknownFields       protoimpl.UnknownFields
...
func (x *UnholdSIPParticipantRequest) Reset() {
	*x = UnholdSIPParticipantRequest{}
	mi := &file_livekit_sip_proto_msgTypes[38]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UnholdSIPParticipantRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UnholdSIPParticipantRequest) ProtoMessage() {}

func (x *UnholdSIPParticipantRequest) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_sip_proto_msgTypes[38]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UnholdSIPParticipantRequest.ProtoReflect.Descriptor instead.
func (*UnholdSIPParticipantRequest) Descriptor() ([]byte, []int) {
	return file_livekit_sip_proto_rawDescGZIP(), []int{38}
}

func (x *UnholdSIPParticipantRequest) GetParticipantIdentity() string {
	if x != nil {
		return x.ParticipantIdentity
	}
	return ""
...
func (x *UnholdSIPParticipantRequest) GetRoomName() string {
	if x != nil {
		return x.RoomName
	}
	return ""
...
type SIPHoldInfo struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	HoldId         string                 `protobuf:"bytes,1,opt,name=hold_id,json=holdId,proto3" json:"hold_id,omitempty"`
	CallId         string                 `protobuf:"bytes,2,opt,name=call_id,json=callId,proto3" json:"call_id,omitempty"`
	HoldStatus     SIPHoldStatus          `protobuf:"varint,3,opt,name=hold_status,json=holdStatus,proto3,enum=livekit.SIPHoldStatus" json:"hold_status,omitempty"`
	Error          string                 `protobuf:"bytes,4,opt,name=error,proto3" json:"error,omitempty"`
	HoldStatusCode *SIPStatus             `protobuf:"bytes,5,opt,name=hold_status_code,json=holdStatusCode,proto3" json:"hold_status_code,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *SIPHoldInfo) Reset() {
	*x = SIPHoldInfo{}
...
func (x *SIPHoldInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SIPHoldInfo) ProtoMessage() {}

func (x *SIPHoldInfo) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_sip_proto_msgTypes[41]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SIPHoldInfo.ProtoReflect.Descriptor instead.
func (*SIPHoldInfo) Descriptor() ([]byte, []int) {
	return file_livekit_sip_proto_rawDescGZIP(), []int{41}
}

func (x *SIPHoldInfo) GetHoldId() string {
	if x != nil {
		return x.HoldId
	}
	return ""
...
func (x *SIPHoldInfo) GetCallId() string {
	if x != nil {
		return x.CallId
	}
	return ""
...
func (x *SIPHoldInfo) GetHoldStatus() SIPHoldStatus {
	if x != nil {
		return x.HoldStatus
	}
	return SIPHoldStatus_SHS_HOLD_ONGOING
}

func (x *SIPHoldInfo) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *SIPHoldInfo) GetHoldStatusCode() *SIPStatus {
	if x != nil {
		return x.HoldStatusCode
	}
	return nil
}
...
const file_livekit_sip_proto_rawDesc = "" +
	...
	"\x19HoldSIPParticipantRequest\x121\n" +
	"\x14participant_identity\x18\x01 \x01(\tR\x13participantIdentity\x12\x1b\n" +
	"\troom_name\x18\x02 \x01(\tR\broomName\"m\n" +
	"\x1bUnholdSIPParticipantRequest\x121\n" +
	"\x14participant_identity\x18\x01 \x01(\tR\x13participantIdentity\x12\x1b\n" +
	"\troom_name\x18\x02 \x01(\tR\broomName\"\xe2\b\n" +
	...
	"\x14transfer_status_code\x18\b \x01(\v2\x12.livekit.SIPStatusR\x12transferStatusCode\"\xcc\x01\n" +
	"\vSIPHoldInfo\x12\x17\n" +
	"\ahold_id\x18\x01 \x01(\tR\x06holdId\x12\x17\n" +
	"\acall_id\x18\x02 \x01(\tR\x06callId\x127\n" +
	"\vhold_status\x18\x03 \x01(\x0e2\x16.livekit.SIPHoldStatusR\n" +
	"holdStatus\x12\x14\n" +
	"\x05error\x18\x04 \x01(\tR\x05error\x12<\n" +
	"\x10hold_status_code\x18\x05 \x01(\v2\x12.livekit.SIPStatusR\x0eholdStatusCode\"\x89\x01\n" +
	"\x06SIPUri\x12\x12\n" +
...
var file_livekit_sip_proto_goTypes = []any{
	...
	(SIPHoldStatus)(0),                    // 6: livekit.SIPHoldStatus
	...
	(*SIPDispatchRule)(nil),               // 35: livekit.SIPDispatchRule
	(*CreateSIPDispatchRuleRequest)(nil),  // 36: livekit.CreateSIPDispatchRuleRequest
	(*UpdateSIPDispatchRuleRequest)(nil),  // 37: livekit.UpdateSIPDispatchRuleRequest
	(*SIPDispatchRuleInfo)(nil),           // 38: livekit.SIPDispatchRuleInfo
	(*SIPDispatchRuleUpdate)(nil),         // 39: livekit.SIPDispatchRuleUpdate
	(*ListSIPDispatchRuleRequest)(nil),    // 40: livekit.ListSIPDispatchRuleRequest
	(*ListSIPDispatchRuleResponse)(nil),   // 41: livekit.ListSIPDispatchRuleResponse
	(*DeleteSIPDispatchRuleRequest)(nil),  // 42: livekit.DeleteSIPDispatchRuleRequest
	(*SIPOutboundConfig)(nil),             // 43: livekit.SIPOutboundConfig
	(*CreateSIPParticipantRequest)(nil),   // 44: livekit.CreateSIPParticipantRequest
	(*SIPParticipantInfo)(nil),            // 45: livekit.SIPParticipantInfo
	(*TransferSIPParticipantRequest)(nil), // 46: livekit.TransferSIPParticipantRequest
	(*HoldSIPParticipantRequest)(nil),     // 47: livekit.HoldSIPParticipantRequest
	(*UnholdSIPParticipantRequest)(nil),   // 48: livekit.UnholdSIPParticipantRequest
	(*SIPCallInfo)(nil),                   // 49: livekit.SIPCallInfo
	(*SIPTransferInfo)(nil),               // 50: livekit.SIPTransferInfo
	(*SIPHoldInfo)(nil),                   // 51: livekit.SIPHoldInfo
	(*SIPUri)(nil),                        // 52: livekit.SIPUri
	nil,                                   // 53: livekit.SIPInboundTrunkInfo.HeadersEntry
	nil,                                   // 54: livekit.SIPInboundTrunkInfo.HeadersToAttributesEntry
	nil,                                   // 55: livekit.SIPInboundTrunkInfo.AttributesToHeadersEntry
	nil,                                   // 56: livekit.SIPOutboundTrunkInfo.HeadersEntry
	nil,                                   // 57: livekit.SIPOutboundTrunkInfo.HeadersToAttributesEntry
	nil,                                   // 58: livekit.SIPOutboundTrunkInfo.AttributesToHeadersEntry
...
var file_livekit_sip_proto_depIdxs = []int32{
	...
	53, // 6: livekit.SIPInboundTrunkInfo.headers:type_name -> livekit.SIPInboundTrunkInfo.HeadersEntry
	54, // 7: livekit.SIPInboundTrunkInfo.headers_to_attributes:type_name -> livekit.SIPInboundTrunkInfo.HeadersToAttributesEntry
	55, // 8: livekit.SIPInboundTrunkInfo.attributes_to_headers:type_name -> livekit.SIPInboundTrunkInfo.AttributesToHeadersEntry
	...
	56, // 21: livekit.SIPOutboundTrunkInfo.headers:type_name -> livekit.SIPOutboundTrunkInfo.HeadersEntry
	57, // 22: livekit.SIPOutboundTrunkInfo.headers_to_attributes:type_name -> livekit.SIPOutboundTrunkInfo.HeadersToAttributesEntry
	58, // 23: livekit.SIPOutboundTrunkInfo.attributes_to_headers:type_name -> livekit.SIPOutboundTrunkInfo.AttributesToHeadersEntry
	...
	32, // 37: livekit.SIPDispatchRule.dispatch_rule_direct:type_name -> livekit.SIPDispatchRuleDirect
	33, // 38: livekit.SIPDispatchRule.dispatch_rule_individual:type_name -> livekit.SIPDispatchRuleIndividual
	34, // 39: livekit.SIPDispatchRule.dispatch_rule_callee:type_name -> livekit.SIPDispatchRuleCallee
	38, // 40: livekit.CreateSIPDispatchRuleRequest.dispatch_rule:type_name -> livekit.SIPDispatchRuleInfo
	35, // 41: livekit.CreateSIPDispatchRuleRequest.rule:type_name -> livekit.SIPDispatchRule
	59, // 42: livekit.CreateSIPDispatchRuleRequest.attributes:type_name -> livekit.CreateSIPDispatchRuleRequest.AttributesEntry
	71, // 43: livekit.CreateSIPDispatchRuleRequest.room_config:type_name -> livekit.RoomConfiguration
	38, // 44: livekit.UpdateSIPDispatchRuleRequest.replace:type_name -> livekit.SIPDispatchRuleInfo
	39, // 45: livekit.UpdateSIPDispatchRuleRequest.update:type_name -> livekit.SIPDispatchRuleUpdate
	35, // 46: livekit.SIPDispatchRuleInfo.rule:type_name -> livekit.SIPDispatchRule
	60, // 47: livekit.SIPDispatchRuleInfo.attributes:type_name -> livekit.SIPDispatchRuleInfo.AttributesEntry
	71, // 48: livekit.SIPDispatchRuleInfo.room_config:type_name -> livekit.RoomConfiguration
	3,  // 49: livekit.SIPDispatchRuleInfo.media_encryption:type_name -> livekit.SIPMediaEncryption
	69, // 50: livekit.SIPDispatchRuleUpdate.trunk_ids:type_name -> livekit.ListUpdate
	35, // 51: livekit.SIPDispatchRuleUpdate.rule:type_name -> livekit.SIPDispatchRule
	61, // 52: livekit.SIPDispatchRuleUpdate.attributes:type_name -> livekit.SIPDispatchRuleUpdate.AttributesEntry
	3,  // 53: livekit.SIPDispatchRuleUpdate.media_encryption:type_name -> livekit.SIPMediaEncryption
	70, // 54: livekit.ListSIPDispatchRuleRequest.page:type_name -> livekit.Pagination
	38, // 55: livekit.ListSIPDispatchRuleResponse.items:type_name -> livekit.SIPDispatchRuleInfo
	1,  // 56: livekit.SIPOutboundConfig.transport:type_name -> livekit.SIPTransport
	62, // 57: livekit.SIPOutboundConfig.headers_to_attributes:type_name -> livekit.SIPOutboundConfig.HeadersToAttributesEntry
	63, // 58: livekit.SIPOutboundConfig.attributes_to_headers:type_name -> livekit.SIPOutboundConfig.AttributesToHeadersEntry
	43, // 59: livekit.CreateSIPParticipantRequest.trunk:type_name -> livekit.SIPOutboundConfig
	64, // 60: livekit.CreateSIPParticipantRequest.participant_attributes:type_name -> livekit.CreateSIPParticipantRequest.ParticipantAttributesEntry
	65, // 61: livekit.CreateSIPParticipantRequest.headers:type_name -> livekit.CreateSIPParticipantRequest.HeadersEntry
	2,  // 62: livekit.CreateSIPParticipantRequest.include_headers:type_name -> livekit.SIPHeaderOptions
	68, // 63: livekit.CreateSIPParticipantRequest.ringing_timeout:type_name -> google.protobuf.Duration
	68, // 64: livekit.CreateSIPParticipantRequest.max_call_duration:type_name -> google.protobuf.Duration
	3,  // 65: livekit.CreateSIPParticipantRequest.media_encryption:type_name -> livekit.SIPMediaEncryption
	66, // 66: livekit.TransferSIPParticipantRequest.headers:type_name -> livekit.TransferSIPParticipantRequest.HeadersEntry
	68, // 67: livekit.TransferSIPParticipantRequest.ringing_timeout:type_name -> google.protobuf.Duration
	67, // 68: livekit.SIPCallInfo.participant_attributes:type_name -> livekit.SIPCallInfo.ParticipantAttributesEntry
	52, // 69: livekit.SIPCallInfo.from_uri:type_name -> livekit.SIPUri
	52, // 70: livekit.SIPCallInfo.to_uri:type_name -> livekit.SIPUri
	7,  // 71: livekit.SIPCallInfo.enabled_features:type_name -> livekit.SIPFeature
	8,  // 72: livekit.SIPCallInfo.call_direction:type_name -> livekit.SIPCallDirection
	4,  // 73: livekit.SIPCallInfo.call_status:type_name -> livekit.SIPCallStatus
	72, // 74: livekit.SIPCallInfo.disconnect_reason:type_name -> livekit.DisconnectReason
	10, // 75: livekit.SIPCallInfo.call_status_code:type_name -> livekit.SIPStatus
	5,  // 76: livekit.SIPTransferInfo.transfer_status:type_name -> livekit.SIPTransferStatus
	10, // 77: livekit.SIPTransferInfo.transfer_status_code:type_name -> livekit.SIPStatus
	6,  // 78: livekit.SIPHoldInfo.hold_status:type_name -> livekit.SIPHoldStatus
	10, // 79: livekit.SIPHoldInfo.hold_status_code:type_name -> livekit.SIPStatus
	1,  // 80: livekit.SIPUri.transport:type_name -> livekit.SIPTransport
	25, // 81: livekit.SIP.ListSIPTrunk:input_type -> livekit.ListSIPTrunkRequest
	13, // 82: livekit.SIP.CreateSIPInboundTrunk:input_type -> livekit.CreateSIPInboundTrunkRequest
	17, // 83: livekit.SIP.CreateSIPOutboundTrunk:input_type -> livekit.CreateSIPOutboundTrunkRequest
	14, // 84: livekit.SIP.UpdateSIPInboundTrunk:input_type -> livekit.UpdateSIPInboundTrunkRequest
	18, // 85: livekit.SIP.UpdateSIPOutboundTrunk:input_type -> livekit.UpdateSIPOutboundTrunkRequest
	21, // 86: livekit.SIP.GetSIPInboundTrunk:input_type -> livekit.GetSIPInboundTrunkRequest
	23, // 87: livekit.SIP.GetSIPOutboundTrunk:input_type -> livekit.GetSIPOutboundTrunkRequest
	27, // 88: livekit.SIP.ListSIPInboundTrunk:input_type -> livekit.ListSIPInboundTrunkRequest
	29, // 89: livekit.SIP.ListSIPOutboundTrunk:input_type -> livekit.ListSIPOutboundTrunkRequest
	31, // 90: livekit.SIP.DeleteSIPTrunk:input_type -> livekit.DeleteSIPTrunkRequest
	36, // 91: livekit.SIP.CreateSIPDispatchRule:input_type -> livekit.CreateSIPDispatchRuleRequest
	37, // 92: livekit.SIP.UpdateSIPDispatchRule:input_type -> livekit.UpdateSIPDispatchRuleRequest
	40, // 93: livekit.SIP.ListSIPDispatchRule:input_type -> livekit.ListSIPDispatchRuleRequest
	42, // 94: livekit.SIP.DeleteSIPDispatchRule:input_type -> livekit.DeleteSIPDispatchRuleRequest
	44, // 95: livekit.SIP.CreateSIPParticipant:input_type -> livekit.CreateSIPParticipantRequest
	46, // 96: livekit.SIP.TransferSIPParticipant:input_type -> livekit.TransferSIPParticipantRequest
	47, // 97: livekit.SIP.HoldSIPParticipant:input_type -> livekit.HoldSIPParticipantRequest
	48, // 98: livekit.SIP.UnholdSIPParticipant:input_type -> livekit.UnholdSIPParticipantRequest
	26, // 99: livekit.SIP.ListSIPTrunk:output_type -> livekit.ListSIPTrunkResponse
	15, // 100: livekit.SIP.CreateSIPInboundTrunk:output_type -> livekit.SIPInboundTrunkInfo
	19, // 101: livekit.SIP.CreateSIPOutboundTrunk:output_type -> livekit.SIPOutboundTrunkInfo
	15, // 102: livekit.SIP.UpdateSIPInboundTrunk:output_type -> livekit.SIPInboundTrunkInfo
	19, // 103: livekit.SIP.UpdateSIPOutboundTrunk:output_type -> livekit.SIPOutboundTrunkInfo
	22, // 104: livekit.SIP.GetSIPInboundTrunk:output_type -> livekit.GetSIPInboundTrunkResponse
	24, // 105: livekit.SIP.GetSIPOutboundTrunk:output_type -> livekit.GetSIPOutboundTrunkResponse
	28, // 106: livekit.SIP.ListSIPInboundTrunk:output_type -> livekit.ListSIPInboundTrunkResponse
	30, // 107: livekit.SIP.ListSIPOutboundTrunk:output_type -> livekit.ListSIPOutboundTrunkResponse
	12, // 108: livekit.SIP.DeleteSIPTrunk:output_type -> livekit.SIPTrunkInfo
	38, // 109: livekit.SIP.CreateSIPDispatchRule:output_type -> livekit.SIPDispatchRuleInfo
	38, // 110: livekit.SIP.UpdateSIPDispatchRule:output_type -> livekit.SIPDispatchRuleInfo
	41, // 111: livekit.SIP.ListSIPDispatchRule:output_type -> livekit.ListSIPDispatchRuleResponse
	38, // 112: livekit.SIP.DeleteSIPDispatchRule:output_type -> livekit.SIPDispatchRuleInfo
	45, // 113: livekit.SIP.CreateSIPParticipant:output_type -> livekit.SIPParticipantInfo
	73, // 114: livekit.SIP.TransferSIPParticipant:output_type -> google.protobuf.Empty
	73, // 115: livekit.SIP.HoldSIPParticipant:output_type -> google.protobuf.Empty
	73, // 116: livekit.SIP.UnholdSIPParticipant:output_type -> google.protobuf.Empty
